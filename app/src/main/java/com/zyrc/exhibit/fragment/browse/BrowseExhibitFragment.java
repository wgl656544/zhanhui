...
public class BrowseExhibitFragment extends Fragment {
    @ViewInject(R.id.rl_view_exhibit)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_view_exhibit, container,false);
...
//            adapter.setNewData(null);
            adapter.setEmptyView(R.layout.item_no_data_layout, (ViewGroup) rlExhibit.getParent());
        }
