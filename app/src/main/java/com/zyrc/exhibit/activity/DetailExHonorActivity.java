...
public class DetailExHonorActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        model.search(handler, UrlConstant.HTTP_URL_DETAIL_EX_HONOR, "exhibId=" + exhibId);
        startLoading("加载中...");
    }
    ...
    private void shoeHonor(CommonBean bean) {
        ...
        adapter.setOnItemClickListener(new DetailHonorAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                startActivity(new Intent(mActivity, WebViewActivity.class).putExtra("url", datas.get(position).getLinkUrl()));
            }
        });
    }
