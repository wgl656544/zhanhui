...
public class FilterView extends LinearLayout implements View.OnClickListener {
    ...
    private FilterEntity selectedCityEntity; // 被选择的排序项
    private FilterEntity selectedNearEntity; // 被选择的筛选项
...
//    private HeaderFilterView headerFilterView = new HeaderFilterView();
    ...
    private void setCityAdapter() {
        ...
        rightAdapter = new FilterRightAdapter(mContext, filterData.getCity());
        lvRight.setAdapter(rightAdapter);
        lvRight.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                rightSelectedCategoryEntity = filterData.getCity().get(position);
                ...
                //修改假视图文本
                HeaderFilterView.setTitle(0, filterData.getCity().get(position).getKey());
                hide();
            }
        });
    }
    ...
    private void setNearAdapter() {
        ...
        lvRight.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                HeaderFilterView.setTitle(1, filterData.getNear().get(position).getKey());
                hide();
            }
        });
    }
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (typeNum != position) {
                    ...
                    if (onItemTypeClickListener != null) {
                        onItemTypeClickListener.onItemTypeClick(typeNum);
                    }
                }
                ...
                HeaderFilterView.setTitle(2, filterData.getType().get(position).getKey());
                hide();
            }
        });
    }
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (siftNum != position) {
                    ...
                    if (onItemSiftClickListener != null) {
                        ...
                        onItemSiftClickListener.onItemSiftClick(sift);
                    }
                }
                ...
                HeaderFilterView.setTitle(3, filterData.getSift().get(position).getKey());
                hide();
            }
        });
    }
