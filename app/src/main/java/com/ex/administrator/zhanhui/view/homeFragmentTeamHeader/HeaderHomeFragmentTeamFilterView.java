 ...
 */
public class HeaderHomeFragmentTeamFilterView implements HomeFragmrntTeamFilterView.OnFilterClickListener {

    @ViewInject(R.id.fv_home_fragment_team_filter)
    HomeFragmrntTeamFilterView fvFilter;
    ...
    public HeaderHomeFragmentTeamFilterView() {
    }

    public HeaderHomeFragmentTeamFilterView(Activity context) {
