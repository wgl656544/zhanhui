        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (success.equals(HandlerConstant.REQUEST_SUCCESS)) {
                        Gson gson = new Gson();
                        DetailExAdvertBean detailExAdvertBean = gson.fromJson(s, DetailExAdvertBean.class);
                        Message message = new Message();
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (success.equals(HandlerConstant.REQUEST_SUCCESS)) {
                        Gson gson = new Gson();
                        DetailExInfoBean detailExInfoBean = gson.fromJson(s, DetailExInfoBean.class);
                        Message message = new Message();
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (success.equals(HandlerConstant.REQUEST_SUCCESS)) {
                        Gson gson = new Gson();
                        DetailExCommonBean detailExCommonBean = gson.fromJson(s, DetailExCommonBean.class);
                        Message message = new Message();
