 ...
 */
public class HeaderHomeFragmentTicketFilterView implements FilterView.OnFilterClickListener {
    ...
    public HeaderHomeFragmentTicketFilterView() {
    }

    public HeaderHomeFragmentTicketFilterView(Activity context) {
