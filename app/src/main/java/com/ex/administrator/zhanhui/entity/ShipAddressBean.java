...
public class ShipAddressBean {
    ...
    public ShipAddressBean(String successed, String code, String message, List<Data> data) {
    ...
    public class Data{
        ...
        public Data(int id, int userId, String type, int tagType, Address address, boolean selChecked) {
            this.id = id;
            this.userId = userId;
            this.type = type;
