...
public class HeaderChannelView implements View.OnClickListener {
    ...
    @ViewInject(R.id.ll_find_ex_other)
    private LinearLayout llFindExhibitionOther;
    ...
    private void initListener() {
        ...
        llFindExhibitionOther.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_find_ex_competition:
                ...
                break;
            //其他按钮
            case R.id.ll_find_ex_other:
                if (onItemChannelClickListtener != null) {
                    onItemChannelClickListtener.OnChannelClick("其他");
                }
                break;
        }
    }
